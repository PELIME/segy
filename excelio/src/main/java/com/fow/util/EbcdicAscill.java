...
public class EbcdicAscill {
    public static void main(String[] args) {
//        try{
//            File file=new File("E:/SGY插值/50_miss.sgy");
//            File outFile=new File("E:/SGY插值/50_ascill.txt");
//            if(!outFile.exists())
...
//            {
//                temp=ebcdicToAsciiBytes(datas,0,1024);
//                bos.write(temp);
//                bos.flush();
//            }
//            fis.close();
...
//        }
        int height=301/256;
        int low=301%256;
        System.out.print("height:"+height+"\tlow:"+low);
    ...
    public static void asciiToEbcdic(byte[] data, byte[] e, int offset) {
        int len = data.length;
        for (int i=0; i<len; i++)
            e[offset + i] = ASCII2EBCDIC[data[i]&0xFF];
    }
    public static void asciiToEbcdic(char[] data, char[] e, int offset) {
        int len = data.length;
        for (int i=0; i<len; i++)
            e[offset + i] = (char) ASCII2EBCDIC[data[i]&0xFF];
    }
}
